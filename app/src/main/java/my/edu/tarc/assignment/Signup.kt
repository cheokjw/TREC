        ...
        bindingSignup.buttonRegister.setOnClickListener(){
            ...
            if(username.isNotEmpty() && fullName.isNotEmpty() && phone.isNotEmpty() && address.isNotEmpty() && email.isNotEmpty() && pass.isNotEmpty() && repass.isNotEmpty()){
                if(pass == repass){
                    ...
                    var regis = Signup_regis(username, fullName, phone, address, email, pass, idSign!!, treeCoin = 0, gameCoin = 0, checkin = 0, treeProgress = 0, spray_quantity = 0, green_quantity = 0, golden_quantity = 0, quizCorrect = 0.0)
